...
/**
     ...
     */
unsigned short NexText_setText(struct NexObject *text, char *buffer);
...
/**
     ...
     * @return true if success, false for failure
     */
unsigned short NexText_Set_background_color_bco(struct NexObject *text, unsigned long number);
...
/**
     ...
     * @return true if success, false for failure
     */
unsigned short NexText_Set_font_color_pco(struct NexObject *text, unsigned long number);
...
/**
     ...
     * @return true if success, false for failure
     */
unsigned short NexText_Set_place_xcen(struct NexObject *text, unsigned long number);
...
/**
     ...
     * @return true if success, false for failure
     */
unsigned short NexText_Set_place_ycen(struct NexObject *text, unsigned long number);
...
/**
     ...
     * @return true if success, false for failure
     */
unsigned short NexText_setFont(struct NexObject *text, unsigned long number);
...
/**
     ...
     * @return true if success, false for failure
     */
unsigned short NexText_Set_background_crop_picc(struct NexObject *text, unsigned long number);
...
/**
     ...
     * @return true if success, false for failure
     */
unsigned short NexText_Set_background_image_pic(struct NexObject *text, unsigned long number);
